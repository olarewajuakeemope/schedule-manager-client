...
var SMHeader = require('./SMHeader');
var SMSegmentedControl = require('./SMSegmentedControl');
var ParallaxBackground = require('./ParallaxBackground');
var ReactNative = require('react-native');
var StyleSheet = require('./SMStyleSheet');
var { Text } = require('./SMText');
var ViewPager = require('./ViewPager');

import type {Item as HeaderItem} from './SMHeader';
  ...
  render() {
    return (
      <View style={{ height: 400 }}>
          <Text>child.props.renderHeader and child.props.renderHeader</Text>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.headerWrapper}>
          <ParallaxBackground
            minHeight={this.state.stickyHeaderHeight + SMHeader.height}
            maxHeight={EMPTY_CELL_HEIGHT + this.state.stickyHeaderHeight + SMHeader.height}
  ...
  componentDidUpdate(prevProps: Props, prevState: State) {
    ...
    if (this.state.idx !== prevState.idx ||
      ...
      if (this._refs[prevState.idx] && this._refs[prevState.idx].getScrollResponder) {
        ...
        NativeModules.SMScrolling.unpin(oldScrollViewTag);
      }
      ...
      if (this._refs[this.state.idx] && this._refs[this.state.idx].getScrollResponder) {
        ...
        NativeModules.SMScrolling.pin(newScrollViewTag, pinnedViewTag, distance);
      }
    }
  }
