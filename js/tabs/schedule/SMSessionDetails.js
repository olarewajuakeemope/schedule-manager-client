/**
 * @flow
 * @providesModule SMSessionDetails
 */
...
var SMFriendGoing = require('./SMFriendGoing');
var SMSpeakerProfile = require('./SMSpeakerProfile');
...
class SMSessionDetails extends React.Component{
  ...
  render() {
    ...
    var locationColor = SMColors.colorForLocation(this.props.session.location);
